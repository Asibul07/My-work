import audioop #useful operations on sound fragments.
import ctypes #foreign function library
import shutil #provides us a number of high-level operations on files.
import subprocess #used to run new codes and applications by creating new processes
import time 
from tkinter.colorchooser import askcolor #graphical user interface module for Python. provides colorchooser module using which color toolbox can be displayed
